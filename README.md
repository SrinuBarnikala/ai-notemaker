...
- **Current Phase:** Phase 15 — Search and Knowledge Memory
...
- **Features:**
  ...
  - Phase 15 (Search and Knowledge Memory): Universal full-text technical search across journeys, living notes, sections, concepts, code snippets, and active recall flashcards with snippet highlighting and instant keyboard spotlight (`Ctrl+K`); cross-journey concept memory and provenance engine (*"You first encountered reranking while learning RAG Architecture..."*); chronological learning history timeline; intelligent related topics and next learning journey recommendations derived from knowledge gaps and concept bridges; contextual in-note memory badges connecting current note sections to prior journeys; and global knowledge memory metrics.
